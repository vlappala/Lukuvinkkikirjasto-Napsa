...
public class Stepdefs {
     ...
     * 
     * @When("tyhja otsikko syotetaan konsoliin") public void
     * tyhjaOtsikkoSyotetaan() throws IOException { String tyhja = "";
     ...
     * ui.run();
     * verify(mockIO).printOutput(eq(vinkki.changeTimeToString(vinkki.getAddDateTime
     * ()) + " " + otsikko));
     * 
     * }
     */
